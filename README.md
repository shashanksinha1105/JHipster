...
To build the final jar and optimize the MyGatewayServiceApp application for production, run:
...
Then navigate to [http://localhost:9899](http://localhost:9899) in your browser.
